...
<body class="font-sans antialiased bg-slate-950" style="font-family: 'Cairo', ui-sans-serif, system-ui, sans-serif;">
    <div class="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div class="absolute top-20 ltr:left-10 rtl:right-10 w-32 h-32 bg-gradient-to-br from-blue-500/20 to-purple-600/20 rounded-3xl blur-xl animate-pulse"></div>
            <div class="absolute bottom-20 ltr:right-10 rtl:left-10 w-40 h-40 bg-gradient-to-br from-red-500/20 to-orange-600/20 rounded-3xl blur-2xl animate-pulse" style="animation-delay: 1s;"></div>
        </div>
        ...
        <div class="relative z-10 max-w-2xl w-full" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
            <div class="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-12 text-center" 
                ...
                {{-- Error Code --}}
                <div class="text-8xl font-bold text-blue-500 mb-6 animate-pulse">404</div>

                {{-- Error Message --}}
                <h1 class="text-3xl font-bold text-white mb-4">The Flux Stopped Flowing</h1>
                <p class="text-xl text-white/70 mb-8">This page has drifted out of your sidebar and into the void.</p>
